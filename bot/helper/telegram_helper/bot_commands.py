...
class _BotCommands:
    def __init__(self):
        ...
        self.UnzipLeechCommand = getCommand('UNZIPLEECH_COMMAND', f'unziptg{CMD_INDEX}')
        self.ZipLeechCommand = getCommand('ZIPLEECH_COMMAND', f'ziptg{CMD_INDEX}')
        self.QbLeechCommand = getCommand('QBLEECH_COMMAND', f'qbtb{CMD_INDEX}')
